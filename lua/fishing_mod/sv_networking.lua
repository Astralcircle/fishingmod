...
function fishingmod.UpdatePlayerInfo(ply, spawned)
	net.Start("Fishingmod:Player")
		net.WriteEntity(ply)
		net.WriteDouble(ply.fishingmod.exp or 0)
		net.WriteDouble(ply.fishingmod.catches or 0)
		net.WriteDouble(ply.fishingmod.money or 0)
		net.WriteInt(ply.fishingmod.length, 16)
		...
		net.WriteInt(ply.fishingmod.rebirth, 16)
